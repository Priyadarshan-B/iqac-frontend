...
const handleShowUnitContent=()=>{
  setShowUnitContent(prevShowUnitContent => !prevShowUnitContent);
      ...
      <div className="dashboard-container">
        <div className="syllabus-entry">
          ...
          >
            ...
            {showcontent ? <ArrowDropUpIcon onClick={handleShowContent} /> : <ArrowDropDownIcon onClick={handleShowContent} />}
    ...
    <div className="division-background" 
    // onClick={handleShowCoPoContent}
    >
    
    <div className="dropdown-section"
              onClick={() => handleDropdownToggle("courseContent")}>
               <div>Course Outcome & Program Outcome</div>
               {showCoPocontent ? <ArrowDropUpIcon onClick={handleShowCoPoContent} /> : <ArrowDropDownIcon onClick={handleShowCoPoContent} />}
    </div>
    ...
    <div style={{ 
          ...
          >
            ...
            >
              ...
              {showunitcontent ? <ArrowDropUpIcon onClick={handleShowUnitContent} /> : <ArrowDropDownIcon onClick={handleShowUnitContent} />}
            </div>
            
            {showunitcontent && <form onSubmit={handleSubmitUnit}>
          <ToastContainer/>
